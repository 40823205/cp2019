...
(function dartProgram() {
  ...
  N = {
    main: function() {
      ...
      $.ctx = t2;
      N.drawUSA(t2);
      t2 = J.get$onClick$x(t1.querySelector("#jap"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new N.main_closure(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#roc"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new N.main_closure0(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = J.get$onClick$x(t1.querySelector("#fra"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new N.main_closure1(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#rus"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new N.main_closure2(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = J.get$onClick$x(t1.querySelector("#usa"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new N.main_closure3(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#uk"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new N.main_closure4(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t2 = J.get$onClick$x(t1.querySelector("#ger"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      W._EventStreamSubscription$(t2._target, t2._eventType, H.functionTypeCheck(new N.main_closure5(), {func: 1, ret: -1, args: [t3]}), false, t3);
      t3 = J.get$onClick$x(t1.querySelector("#net"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      W._EventStreamSubscription$(t3._target, t3._eventType, H.functionTypeCheck(new N.main_closure6(), {func: 1, ret: -1, args: [t2]}), false, t2);
      t1 = J.get$onClick$x(t1.querySelector("#button"));
      t2 = H.getTypeArgumentByIndex(t1, 0);
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new N.main_closure7(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    drawROC: function(ctx) {
      var angle, i, toX, toY;
      ctx.clearRect(0, 0, 250, 206);
      ctx.fillStyle = "rgb(255, 0, 0)";
      ctx.fillRect(0, 0, 250, 206);
      ctx.fillStyle = "rgb(0, 0, 150)";
      ctx.fillRect(0, 0, 125, 103);
      ctx.beginPath();
      for (angle = 0, i = 0; i < 25; ++i) {
        angle += 2.6179938779914944;
        toX = 62.5 + Math.cos(angle) * 31.25;
        toY = 51.5 + Math.sin(angle) * 31.25;
        if (i !== 0)
          ctx.lineTo(toX, toY);
        else
          ctx.moveTo(toX, toY);
      ...
      ctx.fill();
      ctx.beginPath();
      ctx.arc(62.5, 51.5, 17.708333333333332, 0, 6.283185307179586, true);
      ctx.closePath();
      ctx.fillStyle = "rgb(0, 0, 149)";
      ctx.fill();
      ctx.beginPath();
      ctx.arc(62.5, 51.5, 15.625, 0, 6.283185307179586, true);
      ctx.closePath();
      ctx.fillStyle = "#fff";
      ctx.fill();
    },
    drawUSA: function(ctx) {
      var d, i, b, t1, a, i0, t2, angle, i1, toX, toY,
        _s18_ = "rgb(255, 255, 255)";
      ctx.clearRect(0, 0, 250, 206);
      ctx.clearRect(0, 0, 250, 206);
      ctx.fillStyle = "rgb(255, 0, 0)";
      ctx.fillRect(0, 0, 250, 206);
      for (d = 15.4, i = 0; i < 8; ++i)
        if (i !== 0) {
          d += 31;
          ctx.fillStyle = _s18_;
          ctx.fillRect(0, d, 250, 15.846153846153847);
        } else {
          ctx.fillStyle = _s18_;
          ctx.fillRect(0, d, 250, 15.846153846153847);
        }
      ctx.fillRect(0, 200.4, 250, 15.846153846153847);
      ctx.fillStyle = "rgb(0, 0, 150)";
      ctx.fillRect(0, 0, 125, 108.42105263157896);
      ctx.beginPath();
      for (b = 90, i = 0; i < 9; ++i) {
        b -= 10;
        if (i % 2 === 0)
          for (t1 = 11.444444444444445 + b, a = -20, i0 = 0; i0 < 6; ++i0) {
            a += 20;
            for (t2 = 13.88888888888889 + a, angle = 120, i1 = 0; i1 < 5; ++i1) {
              angle += 2.6179938779914944;
              toX = t2 + Math.cos(angle) * 5;
              toY = t1 + Math.sin(angle) * 5;
              if (i1 !== 0)
                ctx.lineTo(toX, toY);
              else
                ctx.moveTo(toX, toY);
          ...
          for (t1 = 11.444444444444445 + b, a = -20, i0 = 0; i0 < 5; ++i0) {
            a += 20;
            for (t2 = 13.88888888888889 + a + 10, angle = 120, i1 = 0; i1 < 5; ++i1) {
              angle += 2.6179938779914944;
              toX = t2 + Math.cos(angle) * 5;
              toY = t1 + Math.sin(angle) * 5;
              if (i1 !== 0)
  ...
  N.main_closure.prototype = {
    call$1: function(e) {
      ...
      t1 = $.ctx;
      t1.clearRect(0, 0, 250, 206);
      t1.fillStyle = "rgb(255, 255, 255)";
      t1.fillRect(0, 0, 250, 206);
      t1.beginPath();
      t1.arc(125, 103, 62.5, 0, 6.283185307179586, true);
      t1.closePath();
  ...
  N.main_closure1.prototype = {
    call$1: function(e) {
      ...
      t1.fillRect(0, 0, 83.33333333333333, 206);
      t1.fillStyle = "rgb(255, 0, 0)";
      t1.fillRect(166.66666666666666, 0, 83.33333333333333, 206);
      return;
    },
    $signature: 0
  };
  N.main_closure2.prototype = {
    call$1: function(e) {
      ...
      t1.fillRect(0, 0, 250, 206);
      t1.fillStyle = "rgb(255, 255, 255)";
      t1.fillRect(0, 0, 250, 68.66666666666667);
      t1.fillStyle = "rgb(255, 0, 0)";
      t1.fillRect(0, 137.33333333333334, 250, 68.66666666666667);
      return;
    },
    $signature: 0
  };
